  ...
  const worldMapOption = {
    ...
    series: [
      ...
      },
      {
        ...
        data: [
          // 国内八个主要城市探测点
          { name: "北京探测点", value: [116.4, 39.9], ip: "202.106.0.20" },
          { name: "上海探测点", value: [121.47, 31.23], ip: "202.127.0.25" },
          { name: "广州探测点", value: [113.23, 23.16], ip: "202.116.0.18" },
          { name: "深圳探测点", value: [114.07, 22.62], ip: "202.104.0.22" },
          { name: "成都探测点", value: [104.07, 30.67], ip: "202.115.0.15" },
          { name: "杭州探测点", value: [120.15, 30.28], ip: "202.108.0.28" },
          { name: "武汉探测点", value: [114.31, 30.59], ip: "202.114.0.19" },
          { name: "西安探测点", value: [108.95, 34.27], ip: "202.117.0.16" },
        ],
      },
    ],
  };
